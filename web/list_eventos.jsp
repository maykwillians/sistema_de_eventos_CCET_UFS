                                ...
                                <div class="media-body">
                                    ...
                                    <aside class="meta category-meta">
                                        <div class="pull-left">
                                            ...
                                            <div class="arc-comment"><h5 style="color: #000000">Horário: <%=horaInicio%></h5></div>
                                            <div class="arc-date"><h5 style="color: #555; font-weight: bold;"><i class="fa fa-eye"></i> Visualizações: <%=evento.getAcessos()%></h5></div>
                                        </div>
                                    </aside>
                                </div>
                            </li>
                            ...
                            <ul>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=1">DPT. DE CIÊNCIA E ENGENHARIA DE MATERIAIS</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=2">DPT. DE COMPUTAÇÃO</a></li>
                                        ...
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=5">DPT. DE ENGENHARIA DE PRODUÇÃO</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=6">DPT. DE ENGENHARIA ELÉTRICA</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=7">DPT. DE ENGENHARIA MECÂNICA</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=8">DPT. DE ENGENHARIA QUÍMICA</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=9">DPT. DE ESTATÍSTICA E CIÊNCIAS ATUARIAIS</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=10">DPT. DE FÍSICA</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=11">DPT. DE GEOLOGIA</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=12">DPT. DE MATEMÁTICA</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=13">DPT. DE QUÍMICA</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=14">DPT. DE TECNOLOGIA DE ALIMENTOS</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=15">NÚCLEO DE ENGENHARIA DE PETRÓLEO</a></li>
                                        <li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=16">DIREÇÃO DO CCET</a></li>
                                        <!--<li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=-1">EMPRESA JÚNIOR DA UFS</a></li>-->
                                        <!--<li><a href="ServletFiltrarEventosDptConfirmados?dptConfirm=-2">ÓRGÃO EXTERNO À UFS</a></li>-->
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="ServletFiltrarEvtsConfirmadosPeloTipoEvt?tipoEvtConfirm=2">Seminário</a></li>
                                        <li><a href="ServletFiltrarEvtsConfirmadosPeloTipoEvt?tipoEvtConfirm=3">Congresso</a></li>
                                        <li><a href="ServletFiltrarEvtsConfirmadosPeloTipoEvt?tipoEvtConfirm=4">Simpósio</a></li>
                                        <li><a href="ServletFiltrarEvtsConfirmadosPeloTipoEvt?tipoEvtConfirm=5">Minicurso</a></li>
                                        <li><a href="ServletFiltrarEvtsConfirmadosPeloTipoEvt?tipoEvtConfirm=6">Apresentação de Projeto ou Estágio</a></li>
                                        <li><a href="ServletFiltrarEvtsConfirmadosPeloTipoEvt?tipoEvtConfirm=7">Apresentação de TCC</a></li>
                                ...
                                <form method="POST" action="ServletFiltrarEvtsConfirmadosPorPalavra" id="formularioPalavra" name="formularioPalavra">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-10">
                                            ...
                                            <span style="color: red; display: none;" id="divErroPalavra">Pesquisa inexistente ou inválida.</span>
                                        </div>
                                        <div class="col-sm-1">
